...
evt.map[176] = function()
	if evt.Cmp("QBits", 707) then         -- "Retrieve the Seasons' Stole from the Hall of the Pit and return it to Gary Zimm in the Bracada Desert."
		if not evt.Cmp("Awards", 52) then         -- "Retrieved the Seasons' Stole"
			evt.OpenChest(0)
			return
		end
	end
...
evt.map[451] = function()
	evt.MoveToMap{X = 2304, Y = 1152, Z = 1, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

Game.MapEvtLines:RemoveEvent(452)
evt.map[452] = function()
	evt.MoveToMap{X = 512, Y = 11200, Z = 64, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

Game.MapEvtLines:RemoveEvent(453)
evt.map[453] = function()
	evt.MoveToMap{X = 512, Y = 7680, Z = -1488, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end
