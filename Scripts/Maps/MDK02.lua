...
evt.map[501] = function()
	if evt.Cmp("MapVar1", 2) then
		...
		evt.MoveToMap{X = -409, Y = 659, Z = -128, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDR02.blv"}
	end
end
...
evt.map[502] = function()
	if evt.Cmp("MapVar0", 2) then
		evt.MoveToMap{X = 518, Y = -44, Z = 0, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDR05.blv"}
	else
