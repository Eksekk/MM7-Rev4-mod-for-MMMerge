...
evt.map[501] = function()
	if evt.Cmp{"MapVar1", Value = 2} then
		evt.MoveToMap{X = -409, Y = 471, Z = -128, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDR02.blv"}
	else
		evt.MoveToMap{X = 1740, Y = -778, Z = -128, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDT01.blv"}
	end
end
