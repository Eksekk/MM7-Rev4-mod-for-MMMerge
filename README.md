...
* Spell effect (damage & healing) is slightly increased by intellect and personality (exact formula is: every 10 points in sum of those stats adds 1% damage). Set Rev4ForMergeIntellectPersonalityIncreaseSpellEffect to 0 to disable.
