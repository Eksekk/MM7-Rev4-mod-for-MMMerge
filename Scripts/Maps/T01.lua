...
evt.map[5] = function()
	if evt.Cmp{"MapVar9", Value = 1} then
		evt.Subtract{"MapVar9", Value = 1}
		evt.SetDoorState{Id = 7, State = 0}
	else
		evt.Add{"MapVar9", Value = 1}
...
evt.map[8] = function()
	if evt.Cmp{"MapVar6", Value = 1} then
		evt.Subtract{"MapVar6", Value = 1}
		evt.SetDoorState{Id = 10, State = 0}
	else
		evt.SetDoorState{Id = 10, State = 1}
		evt.Add{"MapVar6", Value = 1}
	end
end
...
evt.map[176] = function()
	...
	evt.OpenChest{Id = 1}
	evt.Add{"QBits", Value = 744}         -- Altar Piece (Good) - I lost it
end
