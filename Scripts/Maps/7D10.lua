...
evt.map[195] = function()
	if evt.Cmp{"QBits", Value = 751} then         -- Got the Divine Intervention
		evt.OpenChest{Id = 19}
	else
		evt.OpenChest{Id = 0}
		evt.Add{"QBits", Value = 751}         -- Got the Divine Intervention
		evt.Add{"QBits", Value = 738}         -- Book of Divine Intervention - I lost it
	end
end
...
evt.map[502] = function()
	evt.Set{"QBits", Value = 641}         -- Completed Breeding Pit.
	evt.MoveToMap{X = -5376, Y = 474, Z = -415, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 8, Name = "7D26.blv"}
end
