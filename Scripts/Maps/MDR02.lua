...
evt.map[501] = function()
	if evt.Cmp{"MapVar1", Value = 2} then
		evt.MoveToMap{X = 10, Y = -985, Z = 1, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDK05.blv"}
	else
...
evt.map[502] = function()
	if evt.Cmp{"MapVar0", Value = 2} then
		...
		evt.MoveToMap{X = 2074, Y = -281, Z = -128, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDK04.blv"}
	end
end
