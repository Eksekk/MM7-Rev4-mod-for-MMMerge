...
evt.map[501] = function()
	if evt.Cmp{"MapVar1", Value = 2} then
		...
		evt.MoveToMap{X = 146, Y = 3062, Z = -64, Direction = 640, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDT03.blv"}
	end
end
...
evt.map[502] = function()
	if evt.Cmp{"MapVar0", Value = 2} then
		...
		evt.MoveToMap{X = -1045, Y = 1249, Z = 0, Direction = 768, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDK03.blv"}
	end
end
